...
const projectsData = [
  {
    ...
    description:
      "Developed a high-performance auction platform with real-time bidding, payment integration, and automated notifications. Implemented complex business logic for auction listing, bidder verification, and automated auction closings. The system handles thousands of concurrent users with minimal latency.",
    image: listengine,
  ...
  },
  {
    ...
    description:
      "Built a comprehensive healthcare management system for clinics and small hospitals. Features include patient records management, appointment scheduling, billing integration, and medical reporting. Implemented HIPAA-compliant security measures and data encryption.",
  ...
  },
  {
    ...
    description:
      "Created an interactive dashboard for shipping logistics that visualizes global shipping routes, container tracking, and delivery estimates. Implemented integration with multiple shipping carriers' APIs and real-time tracking updates.",
  ...
  },
  {
    ...
    description:
      "Developed a scalable e-commerce solution with features including product catalog management, user authentication, shopping cart functionality, payment processing, and order management. Implemented responsive design for optimal mobile experience.",
